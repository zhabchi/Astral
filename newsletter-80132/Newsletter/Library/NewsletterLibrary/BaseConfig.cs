...
namespace i386.Newsletter
{
	...
	public abstract class BaseConfig
	{
		...
		public BaseConfig(string EncryptFields,string EncryptKey) 
		{
		...
		public BaseConfig(bool DontLoadFromConfig)
		{
		}
		...
		public void ReadKeysFromConfig() 
		{
			...
			foreach(MemberInfo Member in Fields) 
			{
				...
				if (this.ConfigSectionName == "")
					Value = ConfigurationSettings.AppSettings[Fieldname];
				else 
				{
...
<configuration>
				...
				// *** Parse through each of the properties of the properties
				Type typeWebConfig = this.GetType();
    ...
    /// <summary>
    /// Hooking up the Configuration object to a static property with a static constructor
    /// </summary>
    public class App
    {
        public static i386NewsletterConfig ConfigSettings;
        static App()
        {
            ConfigSettings = new i386NewsletterConfig();
        }
    }
    public class i386NewsletterConfig : BaseConfig
    {
        public string UnsubscribeSubject = "Unsubscribe - Your confirmation is required";
        public string SubscribeSubject = "Subscribe - Your confirmation is required";
        public string SubscribeBody = "Subscribe";
        public string UnsubscribeBody = "Unsubscribe";
        public string SMTPServer = "127.0.0.1";
        public string LicenseKey = "DEMO";
        public string CompanyName = "30 Day Trial";
        public string ApplicationURL = GetURL();
        private static string GetURL()
        {
            string AppURL = System.Web.HttpContext.Current.Request.Url.AbsoluteUri;
            string thisURL = "/settings.aspx";
            return AppURL.Substring(0, AppURL.Length - thisURL.Length);
        }
