...
$database_host = "astralmailing.db.5456621.hostedresource.com";

# what is the name of the database we are using
$database_name = "astralmailing";

# what user has access to this database
$database_user = "astralmailing";

# and what is the password to login to control the database
$database_password = 'Pass@ziad1';
...
# for now its off by default until we think it works correctly
define('CLICKTRACK',0);